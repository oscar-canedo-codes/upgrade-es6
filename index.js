...
const allScores = exams.reduce((accumulator, exam) => accumulator + exam.score, 0
);

console.log(allScores);

// 7.2 Dado el mismo array, haz una suma de todos las notas de los exámenes de los alumnos que esten aprobados usando la función .reduce().
